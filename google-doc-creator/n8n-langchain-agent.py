...
system_message = f"""
You are a personal assistant who helps with managing Google Drive and Google Docs. 
...
def get_chunk_text(chunk):
    ...
    # print("The response content: ", response_content)
...
def prompt_ai(messages):
    ...
    n8n_chatbot = ChatGoogleGenerativeAI(model=model, api_key=GEMINI_API_KEY)
    ...
    # print(f"The gathered response: {gathered}")
...
async def main():
    ...
    if prompt := st.chat_input("What would you like to do today?"):
        ...
        with st.chat_message("assistant"):
            ...
            # print("The streamlit message history: ", st.session_state.messages,
            #       "/n/n-------------------/n/n-------------------------")
